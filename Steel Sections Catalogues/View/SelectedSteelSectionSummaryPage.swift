...
class SelectedSteelSectionSummaryPage: UIViewController {
    ...
    let steelSectionProfileDimensionAnnotationLabelsFontColourInsideTheProfileDrawingArea = UIColor(named: "Text Font Colour for Sub Labels Inside the Section Dimensional & Structural Properties Scroll View")
    ...
    let steelSectionProfileDimensionLabelsAbbreviationLettersFontColourInsideTheProfileDrawingArea = UIColor(named: "Text Font Colour for Sub Labels Abbreviation Letters Inside the Section Dimensional & Structural Properties Scroll View")
    ...
    override func viewDidLoad() {
        ...
        steelSectionDrawingView.addSubview(selectedSectionDimensionDepthLabel)
