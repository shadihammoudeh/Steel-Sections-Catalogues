//
//  BlueBookUniversalColumnsSectionsToEurocodesFilterByViewController.swift
...
class BlueBookUniversalColumnsSectionsToEurocodesFilterByViewController: UIViewController {
    ...
    lazy var navigationBar = CustomUINavigationBar(navBarLeftButtonTarget: self, navBarLeftButtonSelector: #selector(navigationBarLeftButtonPressed(sender:)), labelTitleText: "UC Data Filter", navBarDelegate: self)
    ...
    override func viewDidLoad() {
        ...
        extractedDepthOfSection = universalColumnsDataArrayReceivedFromBlueBookUniversalColumnsVC.map({ return $0.depthOfSection })
        
        extractedWidthOfSection = universalColumnsDataArrayReceivedFromBlueBookUniversalColumnsVC.map({ return $0.widthOfSection })
        
        extractedSectionWebThickness = universalColumnsDataArrayReceivedFromBlueBookUniversalColumnsVC.map({ return $0.sectionWebThickness })
        
        extractedSectionFlangeThickness = universalColumnsDataArrayReceivedFromBlueBookUniversalColumnsVC.map({ return $0.sectionFlangeThickness })
        
        extractedSectionArea = universalColumnsDataArrayReceivedFromBlueBookUniversalColumnsVC.map({ return $0.areaOfSection })
    ...
    @objc func buttonPressed(_ sender: UIButton) {
        ...
        if sender.tag == 1 {
            ...
            if customDepthOfSectionRangeSlider?.selectedMinValue == CGFloat(minimumDepthOfSection!) && customDepthOfSectionRangeSlider?.selectedMaxValue == CGFloat(maximumDepthOfSection!) && customWidthOfSectionRangeSlider?.selectedMinValue == CGFloat(minimumWidthOfSection!) && customWidthOfSectionRangeSlider?.selectedMaxValue == CGFloat(maximumWidthOfSection!) && customSectionWebThicknessSlider?.selectedMinValue == CGFloat(minimumSectionWebThickness!) && customSectionWebThicknessSlider?.selectedMaxValue == CGFloat(maximumSectionWebThickness!) && customSectionFlangeThicknessSlider?.selectedMinValue == CGFloat(minimumSectionFlangeThickness!) && customSectionFlangeThicknessSlider?.selectedMaxValue == CGFloat(maximumSectionFlangeThickness!) && customSectionAreaSlider?.selectedMinValue == CGFloat(minimumAreaOfSection!) && customSectionAreaSlider?.selectedMaxValue == CGFloat(maximumAreaOfSection!) {
                ...
                filteredArrayToBeSentBack = universalColumnsDataArrayReceivedFromBlueBookUniversalColumnsVC
...
extension BlueBookUniversalColumnsSectionsToEurocodesFilterByViewController: UINavigationBarDelegate {
...
extension BlueBookUniversalColumnsSectionsToEurocodesFilterByViewController: RangeSeekSliderDelegate {
