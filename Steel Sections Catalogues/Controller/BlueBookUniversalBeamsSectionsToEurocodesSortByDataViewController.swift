...
class BlueBookUniversalBeamsSectionsToEurocodesSortByDataViewController: UIViewController {
...
extension BlueBookUniversalBeamsSectionsToEurocodesSortByDataViewController: UIPickerViewDelegate, UIPickerViewDataSource {
